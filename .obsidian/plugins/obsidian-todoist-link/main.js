...
function createProject(title, deepLink, api) {
  api.addProject({ name: title }).then((project) => {
    ...
    if (view == null) {
      ...
      const h1Index = lines.findIndex((line2) => line2.startsWith("#"));
      if (h1Index !== -1) {
        const startRange = {
          line: h1Index,
...
function createTask(processedLine, deepLink, api, transformToLink) {
      ...
      this.addCommand({
        ...
        editorCallback: (editor, view) => {
          ...
          if (activeFile == null) {
            ...
            const task = prepareTask(line2, this.app, activeFile);
